...
from torchmeta.datasets import (Omniglot, MiniImagenet, TieredImagenet, CIFARFS,
                                CUB, DoubleMNIST, TripleMNIST, Pascal5i, MITStates)
...
def mit_states(folder, shots, ways, shuffle=True, test_shots=None,
        seed=None, **kwargs):
    """Helper function to create a meta-dataset for the hand designed dataset.
    ...
    return helper_with_default(MITStates, folder, shots, ways,
                               shuffle=shuffle, test_shots=test_shots,
                               seed=seed, defaults=defaults, **kwargs)
